...
/* ./.libs/lt-test_libpostal.c - temporary wrapper executable for .libs/test_libpostal.exe
   Generated by libtool (GNU libtool) 2.4.6

   The test_libpostal program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\LibPostalRepository\\libpostal\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\msys64\\usr\\local\\lib;C:\\msys64\\usr\\local\\bin;C:\\LibPostalRepository\\libpostal\\src\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "test_libpostal.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_libpostal - temporary wrapper script for .libs/test_libpostal.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The test_libpostal program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libpostal.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"test_libpostal.exe:test_libpostal:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_libpostal.exe:test_libpostal:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_libpostal.exe:test_libpostal:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_libpostal.exe'\n", f);
  ...
  fputs ("    PATH=/usr/local/lib:/usr/local/bin:/c/LibPostalRepository/libpostal/src/.li", f);
  fputs ("bs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/LibPostalRepository/libpostal/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
